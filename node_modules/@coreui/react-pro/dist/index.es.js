...
import React__default$1, { createContext, forwardRef, useState, useRef, useContext, useEffect, Children, isValidElement, cloneElement, useMemo, useLayoutEffect, useCallback } from 'react';
...
var CSSTransition = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default$1.createElement(Transition, _extends$1({}, props, {
...
var TransitionGroup = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default$1.createElement(TransitionGroupContext.Provider, {
      value: contextValue
    }, /*#__PURE__*/React__default$1.createElement(Component, props, children));
  };
...
var ReplaceTransition = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.handleLifecycle = function handleLifecycle(handler, idx, originalArgs) {
    ...
    var child = React__default$1.Children.toArray(children)[idx];
  ...
  _proto.render = function render() {
    ...
    var _React$Children$toArr = React__default$1.Children.toArray(children),
    ...
    return /*#__PURE__*/React__default$1.createElement(TransitionGroup, props, inProp ? React__default$1.cloneElement(first, {
      key: 'first',
      onEnter: this.handleEnter,
      onEntering: this.handleEntering,
      onEntered: this.handleEntered
    }) : React__default$1.cloneElement(second, {
      key: 'second',
...
ReplaceTransition.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  children: function children(props, propName) {
    if (React__default$1.Children.count(props[propName]) !== 2) return new Error("\"" + propName + "\" must be exactly two transition components.");
    return null;
  }
} : {};
...
function areChildrenDifferent(oldChildren, newChildren) {
  ...
  if (React__default$1.isValidElement(oldChildren) && React__default$1.isValidElement(newChildren) && oldChildren.key != null && oldChildren.key === newChildren.key) {
    return false;
  }
...
var leaveRenders = (_leaveRenders = {}, _leaveRenders[modes.out] = function (_ref) {
  ...
  return React__default$1.cloneElement(current, {
    in: false,
  ...
  return [current, React__default$1.cloneElement(children, {
    in: true,
...
var enterRenders = (_enterRenders = {}, _enterRenders[modes.out] = function (_ref3) {
  ...
  return React__default$1.cloneElement(children, {
    in: true,
    onEntered: callHook(children, 'onEntered', function () {
      changeState(ENTERED, React__default$1.cloneElement(children, {
        in: true
      }));
    })
  });
  ...
  }), React__default$1.cloneElement(children, {
    in: true
  })];
}, _enterRenders);
/**
...
var SwitchTransition = /*#__PURE__*/function (_React$Component) {
  ...
  SwitchTransition.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    return {
      current: React__default$1.cloneElement(props.children, {
        in: true
      })
    };
  };
...
var CCollapse = forwardRef(function (_a, ref) {
    ...
    return (React__default$1.createElement(CSSTransition, { in: visible, nodeRef: collapseRef, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited, timeout: 350 }, function (state) {
...
var CCloseButton = forwardRef(function (_a, ref) {
    ...
    return (React__default$1.createElement("button", __assign$1({ type: "button", className: _className, "aria-label": "Close", disabled: disabled }, rest, { ref: ref })));
});
...
var CAlert = forwardRef(function (_a, ref) {
    ...
    return (React__default$1.createElement(Transition, { in: _visible, mountOnEnter: true, nodeRef: alertRef, onExit: onClose, timeout: 150, unmountOnExit: true }, function (state) {
        var transitionClass = getTransitionClass(state);
...
var CBackdrop = forwardRef(function (_a, ref) {
    ...
    return (React__default$1.createElement(Transition, { in: visible, mountOnEnter: true, nodeRef: backdropRef, timeout: 150, unmountOnExit: true }, function (state) {
        var transitionClass = getTransitionClass(state);
...
var CCalendar = forwardRef(function (_a, ref) {
    ...
    var _h = useState(calendarDate ? new Date(calendarDate) : startDate ? new Date(startDate) : new Date()), _calendarDate = _h[0], setCalendarDate = _h[1];
    useEffect(function () {
        if (calendarDate) {
    ...
    var _l = useState(null), _hoverDate = _l[0], setHoverDate = _l[1];
    ...
    var Calendar = function (props) {
        ...
        return (React__default$1.createElement("table", null,
            view === 'days' && (React__default$1.createElement("thead", null,
                React__default$1.createElement("tr", null, weekDays.map(function (_a, idx) {
                    ...
                    return (React__default$1.createElement("th", { key: idx, className: "calendar-cell" },
                        React__default$1.createElement("div", { className: "calendar-header-cell-inner" }, typeof weekdayFormat === 'function'
                            ? weekdayFormat(date)
            ...
            React__default$1.createElement("tbody", null,
                view === 'days' &&
    ...
    var Navigation = function (props) {
        ...
        return (React__default$1.createElement("div", { className: "calendar-nav" },
            ...
            React__default$1.createElement("div", __assign$1({ className: "calendar-nav-date" }, (navYearFirst && { style: { display: 'flex', justifyContent: 'center' } })),
                view === 'days' && (React__default$1.createElement(CButton, { color: "transparent", size: "sm", onClick: function () { return navigation && setView('months'); } }, date.toLocaleDateString(locale, { month: 'long' }))),
                React__default$1.createElement(CButton, __assign$1({ color: "transparent", size: "sm", onClick: function () { return navigation && setView('years'); } }, (navYearFirst && { style: { order: '-1' } })), date.toLocaleDateString(locale, { year: 'numeric' }))),
    ...
    return (React__default$1.createElement("div", { className: classNames$1('calendars', className) }, Array.from({ length: calendars }, function (_, index) { return (React__default$1.createElement("div", { className: classNames$1('calendar', view), key: index, ref: ref },
...
var CFormInput = forwardRef(function (_a, ref) {
    ...
    return (React__default$1.createElement(CFormControlWrapper, { describedby: rest['aria-describedby'], feedback: feedback, feedbackInvalid: feedbackInvalid, feedbackValid: feedbackValid, floatingLabel: floatingLabel, id: id, invalid: invalid, label: label, text: text, tooltipFeedback: tooltipFeedback, valid: valid },
        React__default$1.createElement("input", __assign$1({ className: _className, id: id, type: type, onChange: function (event) { return (delay ? setValue(event) : onChange && onChange(event)); } }, rest, { ref: ref }), children)));
});
...
var CFormTextarea = forwardRef(function (_a, ref) {
    ...
    return (React__default$1.createElement(CFormControlWrapper, { describedby: rest['aria-describedby'], feedback: feedback, feedbackInvalid: feedbackInvalid, feedbackValid: feedbackValid, floatingLabel: floatingLabel, id: id, invalid: invalid, label: label, text: text, tooltipFeedback: tooltipFeedback, valid: valid },
        React__default$1.createElement("textarea", __assign$1({ className: _className, id: id }, rest, { ref: ref }), children)));
});
...
var CTimePicker = forwardRef(function (_a, ref) {
    ...
    var InputGroup = function () { return (React__default$1.createElement(CInputGroup, { className: "picker-input-group", size: size },
        React__default$1.createElement(CFormInput, { delay: true, disabled: disabled, onChange: function (event) {
...
var CDateRangePicker = forwardRef(function (_a, ref) {
    ...
    var _q = useState(null), inputStartHoverValue = _q[0], setInputStartHoverValue = _q[1];
    var _r = useState(null), inputEndHoverValue = _r[0], setInputEndHoverValue = _r[1];
    var _s = useState(calendarDate ? new Date(calendarDate) : new Date()), _calendarDate = _s[0], setCalendarDate = _s[1];
    var _t = useState(startDate ? new Date(startDate) : null), _startDate = _t[0], setStartDate = _t[1];
    var _u = useState(endDate ? new Date(endDate) : null), _endDate = _u[0], setEndDate = _u[1];
    var _v = useState(startDate ? new Date(startDate) : null), initialStartDate = _v[0], setInitialStartDate = _v[1];
    var _w = useState(endDate ? new Date(endDate) : null), initialEndDate = _w[0], setInitialEndDate = _w[1];
    var _x = useState(maxDate ? new Date(maxDate) : null), _maxDate = _x[0], setMaxDate = _x[1];
    var _y = useState(minDate ? new Date(minDate) : null), _minDate = _y[0], setMinDate = _y[1];
    var _z = useState(false), selectEndDate = _z[0], setSelectEndDate = _z[1];
    useEffect(function () {
    ...
    return (React__default$1.createElement(CPicker, __assign$1({ className: _className, disabled: disabled, footer: footer || timepicker, footerContent: todayButton && (React__default$1.createElement(CButton, { className: "me-auto", color: todayButtonColor, size: todayButtonSize, variant: todayButtonVariant, onClick: function () {
                var date = new Date();
...
var CDatePicker = forwardRef(function (_a, ref) {
    ...
    return (React__default$1.createElement(CDateRangePicker, __assign$1({ calendars: 1, id: id, startDate: date, onStartDateChange: onDateChange, placeholder: placeholder, range: false, ref: ref }, rest)));
});
...
var CModal = forwardRef(function (_a, ref) {
    ...
    return (React__default$1.createElement(React__default$1.Fragment, null,
        React__default$1.createElement(Transition, { in: _visible, mountOnEnter: true, nodeRef: modalRef, onEnter: onShow, onExit: onClose, unmountOnExit: unmountOnClose, timeout: !transition ? 0 : duration }, function (state) {
            var transitionClass = getTransitionClass(state);
...
var CMultiSelect = forwardRef(function (_a, ref) {
    ...
    var _q = useState(options), _options = _q[0], setOptions = _q[1];
    var _r = useState(options), _vOptions = _r[0], setVOptions = _r[1];
    ...
    return (React__default$1.createElement(React__default$1.Fragment, null,
        ...
        React__default$1.createElement(CPicker, { className: _className, disabled: disabled, toggler: React__default$1.createElement("div", null,
                React__default$1.createElement(CMultiSelectSelection, { multiple: multiple, onRemove: function (option) { return !disabled && handleOptionOnClick(option); }, search: search, selected: selected, selectionType: selectionType, selectionTypeCounterText: selectionTypeCounterText }),
                ...
                search && (React__default$1.createElement(CMultiSelectSearchInput, __assign$1({ disabled: disabled }, (selected.length === 0 && { placeholder: placeholder }), (selected.length &&
                    selectionType === 'counter' && {
            ...
            React__default$1.createElement(React__default$1.Fragment, null,
                ...
                React__default$1.createElement(CMultiSelectOptions, { handleOptionOnClick: function (option) { return !disabled && handleOptionOnClick(option); }, options: _vOptions, optionsMaxHeight: optionsMaxHeight, optionsStyle: optionsStyle, searchNoResultsLabel: searchNoResultsLabel })))));
});
...
var CNavGroup = forwardRef(function (_a, ref) {
    ...
    return (React__default$1.createElement("li", __assign$1({ className: _className }, rest, { ref: ref }),
        ...
        React__default$1.createElement(Transition, { in: _visible, nodeRef: navItemsRef, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited, timeout: 300 }, function (state) { return (React__default$1.createElement("ul", { className: classNames$1('nav-group-items', {
                compact: compact,
...
var COffcanvas = forwardRef(function (_a, ref) {
    ...
    return (React__default$1.createElement(React__default$1.Fragment, null,
        React__default$1.createElement(Transition, { in: _visible, nodeRef: offcanvasRef, onEnter: onShow, onEntered: function () { var _a; return (_a = offcanvasRef.current) === null || _a === void 0 ? void 0 : _a.focus(); }, onExit: onHide, timeout: 300 }, function (state) {
            return typeof window !== 'undefined' && portal
...
var CPopover = function (_a) {
    ...
    return (React__default$1.createElement(React__default$1.Fragment, null,
        React__default$1.cloneElement(children, __assign$1(__assign$1(__assign$1({ ref: setReferenceElement }, ((trigger === 'click' || trigger.includes('click')) && {
        ...
        typeof window !== 'undefined' &&
            createPortal(React__default$1.createElement(Transition, { in: _visible, mountOnEnter: true, nodeRef: popoverRef, onEnter: onShow, onExit: onHide, timeout: {
                    enter: 0,
                    exit: 200,
                }, unmountOnExit: true }, function (state) {
                var transitionClass = getTransitionClass(state);
                return (React__default$1.createElement("div", __assign$1({ className: classNames$1("popover bs-popover-".concat(placement === 'left' ? 'start' : placement === 'right' ? 'end' : placement), transitionClass), ref: setPopperElement, role: "tooltip", style: styles.popper }, attributes.popper, rest),
                    React__default$1.createElement("div", { className: "popover-arrow", style: styles.arrow, ref: setArrowElement }),
...
var CTableDataCell = forwardRef(function (_a, ref) {
    ...
    return (React__default$1.createElement(Component, __assign$1({ className: _className ? _className : undefined }, rest, { ref: ref }), children));
});
...
var CTableResponsiveWrapper = function (_a) {
    ...
    return responsive ? (React__default$1.createElement("div", __assign$1({ className: typeof responsive === 'boolean' ? 'table-responsive' : "table-responsive-".concat(responsive) }, rest), children)) : (children);
};
...
var CTable = forwardRef(function (_a, ref) {
    ...
    return (React__default$1.createElement(CTableResponsiveWrapper, { responsive: responsive },
        React__default$1.createElement("table", __assign$1({ className: _className }, rest, { ref: ref }),
            ((caption && caption !== 'top') || captionTop) && (React__default$1.createElement(CTableCaption, null, caption || captionTop)),
            columns && (React__default$1.createElement(CTableHead, __assign$1({}, tableHeadProps),
                React__default$1.createElement(CTableRow, null, columns.map(function (column, index) { return (React__default$1.createElement(CTableHeaderCell, __assign$1({}, (column._props && __assign$1({}, column._props)), (column._style && { style: __assign$1({}, column._style) }), { key: index }), label(column))); })))),
            items && (React__default$1.createElement(CTableBody, null, items.map(function (item, index) { return (React__default$1.createElement(CTableRow, __assign$1({}, (item._props && __assign$1({}, item._props)), { key: index }), rawColumnNames.map(function (colName, index) {
                return item[colName] ? (React__default$1.createElement(CTableDataCell, __assign$1({}, (item._cellProps && __assign$1(__assign$1({}, (item._cellProps['all'] && __assign$1({}, item._cellProps['all']))), (item._cellProps[colName] && __assign$1({}, item._cellProps[colName])))), { key: index }), item[colName])) : null;
            }))); }))),
            children,
            footer && (React__default$1.createElement(CTableFoot, __assign$1({}, tableFootProps),
                React__default$1.createElement(CTableRow, null, footer.map(function (item, index) { return (React__default$1.createElement(CTableDataCell, __assign$1({}, (item._props && __assign$1({}, item._props)), { key: index }), typeof item === 'object' ? item.label : item)); })))))));
});
CTable.propTypes = {
    align: propTypes$1.exports.oneOf(['bottom', 'middle', 'top']),
        ...
        columnFilter && (React__default$1.createElement(CTableRow, null,
            ...
            columns.map(function (column, index) {
                return (React__default$1.createElement(CTableHeaderCell, __assign$1({}, tableHeaderCellProps(column), { key: index }), (typeof column !== 'object'
                    ...
                    })) : (React__default$1.createElement(CFormInput, { size: "sm", onInput: function (event) {
    ...
    return (React__default$1.createElement(React__default$1.Fragment, null,
        ...
        React__default$1.createElement("div", { className: "position-relative" },
            React__default$1.createElement(CTable, __assign$1({}, tableProps),
                ...
                footer && (React__default$1.createElement(CSmartTableHead, __assign$1({ component: CTableFoot }, tableFootProps, { columnFilter: false, columnSorter: false, columns: columns ? columns : rawColumnNames, items: _items, handleSelectAllChecked: function () { return handleSelectAllChecked(); }, selectable: selectable, selectAll: selectedAll })))),
...
var CTabPane = forwardRef(function (_a, ref) {
    ...
    return (React__default$1.createElement(Transition, { in: visible, nodeRef: tabPaneRef, onEnter: onShow, onExit: onHide, timeout: 150 }, function (state) {
        var transitionClass = getTransitionClass(state);
...
var CToast = forwardRef(function (_a, ref) {
    ...
    return (React__default$1.createElement(Transition, { in: _visible, nodeRef: toastRef, onEnter: function () { return onShow && onShow(index ? index : null); }, onExited: function () { return onClose && onClose(index ? index : null); }, timeout: 250, unmountOnExit: true }, function (state) {
        var transitionClass = getTransitionClass(state);
...
var CTooltip = function (_a) {
    ...
    return (React__default$1.createElement(React__default$1.Fragment, null,
        ...
        typeof window !== 'undefined' &&
            createPortal(React__default$1.createElement(Transition, { in: _visible, mountOnEnter: true, nodeRef: tooltipRef, onEnter: onShow, onExit: onHide, timeout: {
                    enter: 0,
                    exit: 200,
                }, unmountOnExit: true }, function (state) {
                var transitionClass = getTransitionClass(state);
                return (React__default$1.createElement("div", __assign$1({ className: classNames$1("tooltip bs-tooltip-".concat(placement === 'left' ? 'start' : placement === 'right' ? 'end' : placement), transitionClass), ref: setPopperElement, role: "tooltip", style: styles.popper }, attributes.popper, rest),
                    React__default$1.createElement("div", { className: "tooltip-arrow", style: styles.arrow, ref: setArrowElement }),
